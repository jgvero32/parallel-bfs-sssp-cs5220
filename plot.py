...
plt.title('1D BFS Time on soc-LiveJournal1 vs Number of Processors')
...
plt.plot(x, roadNet, linestyle='-', color = "blue", label = "roadNet-CA")
plt.plot(ideal_x, ideal_roadNet, color = "blue", linestyle="--", label = "ideal roadNet-CA")
plt.plot(x, liveJournal, color = "orange", label = "soc-LiveJournal1")
